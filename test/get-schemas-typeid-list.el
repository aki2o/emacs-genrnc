...
(expectations
  (desc "get-schemas-typeid-list 0")
  (expect nil
    (let* ((tdir (tenv-get-tmp-directory "genrnc" t t))
      ...
      (tenv-update-file sfile t
                        ...
                        "</locatingRules>\n")
      (genrnc--get-schemas-typeid-list "11"))))

(expectations
  (desc "get-schemas-typeid-list 1")
...
(expectations
  (desc "get-schemas-typeid-list 2")
  (expect '("[genrnc-11]" "SpringFrameWork Tool")
    (let* ((tdir (tenv-get-tmp-directory "genrnc" t t))
           (sfile (tenv-get-tmp-file "genrnc" genrnc--schemas-file-name))
           (genrnc-user-schemas-directory tdir))
      (tenv-update-file sfile t
